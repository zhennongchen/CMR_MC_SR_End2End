...
def train(val_batch,trial_name,data_sheet, epochs, load_model_file):
  ...
  _,_,_,_, _,_,_,y_img_list_trn,_,_, x_list_trn, center_list_trn = b.__build__(batch_list = train_batch)
  _,_,_,_, _,_,_,y_img_list_val,_,_, x_list_val, center_list_val = b.__build__(batch_list = [val_batch])

  # n = np.arange(0,1,1)
  # x_list_trn = x_list_trn[n]; center_list_trn = center_list_trn[n]; y_img_list_trn = y_img_list_trn[n]
  # x_list_val = x_list_trn; center_list_val = center_list_trn; y_img_list_val = y_img_list_trn

  print(x_list_trn[0:3],center_list_trn[0:3], y_img_list_trn[0:3], x_list_val[0:3],center_list_val[0:3], y_img_list_val[0:3])
  ...
  model.compile(optimizer= opt, 
                loss = [hyper.custom_mae_loss, hyper.dice_loss_two_classes],
...
def main(val_batch):
    ...
    load_model_file = None#os.path.join(cg.model_dir,'STN_1','models/batch_0','model-042-first.hdf5')
